    ...
    <div id={styles.outerContainer}>
      ...
      <div id={styles.innerContainer}>
        ...
        <p>
          ...
          either full-height, part-height, or bulkhead walls. While they do not
          support gravity loads from the primary building structure, they still
          need to be designed for earthquake, wind, and impact loads in
          accordance with AS/NZS 1170.2, AS/NZS 1170.5, NZS 3603, and NZS 4600.
        </p>
        <p>
          The specific design of partitions has often been an overlooked part of
          a build. However, from our teams' experience with builds across
          ...
          generally many different characteristics that will dictate the design
          of a wall. These include but are not limited to, wall height, heavy or
          multiple linings, wall openings, large glazing fill-in partitions,
          acoustic studs, external or internal wind pressures, and wall-mounted
        ...
        <p>
          Throughout our years of experience, the team at SRS has seen and done
          it all - from glass brick walls to full-height atrium walls, from
          stone-lined feature walls to fire-rated bulkhead walls, and by using
          this experience our team will strive to come up with the most
